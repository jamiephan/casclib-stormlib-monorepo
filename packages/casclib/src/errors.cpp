...
std::string FormatCascError() {
  ...
  switch (code) {
    ...
    case ERROR_FILE_ENCRYPTED:         name = "ERROR_FILE_ENCRYPTED"; break;
    case ERROR_FILE_TOO_LARGE:         name = "ERROR_FILE_TOO_LARGE"; break;
    case ERROR_NETWORK_NOT_AVAILABLE:  name = "ERROR_NETWORK_NOT_AVAILABLE"; break;
    case ERROR_CANCELLED:              name = "ERROR_CANCELLED"; break;
  }
  return " (CascError=" + std::to_string(code) + " " + name +
